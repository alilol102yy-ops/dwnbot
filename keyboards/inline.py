...
def get_main_menu_keyboard(lang_code: str, bot_username: str = "") -> InlineKeyboardMarkup:
    text_map = {
        'ar': ("اللغة", "المنصات المدعومة", "مشاركة"),
        'en': ("Language", "Platforms", "Share"),
        'zh': ("语言", "支持平台", "分享"),
        'fr': ("Langue", "Plateformes", "Partager"),
        'es': ("Idioma", "Plataformas", "Compartir"),
    }
    lang_btn, plat_btn, share_btn = text_map.get(lang_code, text_map['en'])
    share_url = f"https://t.me/share/url?url=https://t.me/{bot_username}&text=Media%20Downloader"
